    ...
    Public Class Get_NetworkConnections
        ...
        Protected Overrides Sub ProcessRecord()
            For Each nic In IcsManager.GetIPv4EthernetAndWirelessInterfaces()
                ...
                Dim record = New With {Key .Name = nic.Name,
                                       Key .GUID = nic.Id,
                                       Key .MAC = nic.GetPhysicalAddress(),
                                       Key .Description = nic.Description,
                                       Key .SharingEnabled = configuration.SharingEnabled,
                                       Key .NetworkAdapter = nic,
